          ...
          <div class="card-body">
            <form action="function.php" method="POST">
                ...
                if (isset($_GET['edit'])) {
                  ...
                  $queryTodos = mysqli_query($dbconnect,"SELECT * FROM todos WHERE todo_id='$todo_id'");
                ...
                ?>
                  <div class="mb-3 pl-3 ps-3 pe-3">
                    ...
                    <input type="text" class="form-control" name="judul" value="<?= $dataTodos['todo_judul'] ?>">
                  </div>
                  <div class="mb-3 pl-3 ps-3 pe-3">
                    <label class="form-label text-secondary fw-bolder">Deadline</label>
                    <input type="date" class="form-control" name="tanggal" value="<?= $dataTodos['todo_tanggal'] ?>">
                  </div>
                  <div class="mb-3 pl-3 ps-3 pe-3">
                    <label class="form-label text-secondary fw-bolder">Status</label>
                    <select class="form-select" name="status">
                      <?php
                      if ($dataTodos['todo_status']==='Selesai') {
                      ?>
